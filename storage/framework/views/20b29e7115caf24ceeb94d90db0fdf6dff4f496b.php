		  ...
		  <div>
			<ul class="menu"> 
				 ...
				 <li><a href="#">Controle de TCC</a>   
				  <ul class="submenu-1"> 
				   <li><a href="#">Área Geral</a></li>   
				   			<li><a href="<?php echo e(route('geral.listap')); ?>">Listar Professores</a></li>          
				    <li><a href="#">Área Administrativa</a></li> 
				    		<li><a href="<?php echo e(route('geral.listap')); ?>">Listar Professores</a></li>  
				    		<li><a href="<?php echo e(route('geral.relatorio')); ?>">Listar Projetos</a></li> 
				    		<li><a href="<?php echo e(route('geral.listaaluno')); ?>">Listar Alunos</a></li> </u>  <br><br>
				...
				  
				 ...
				 <li><a href="#">Lista</a>   
				  <ul class="submenu-1">      
				   <li><a href="<?php echo e(route('geral.listaaluno')); ?>">Listar Alunos </a></li>           
				    <li><a href="<?php echo e(route('geral.listap')); ?>">Listar Professores</a></li> 
				    <li><a href="<?php echo e(route('about')); ?>">About</a></li> </ul>
				  
			</li>    
			   
...
</body><?php /**PATH C:\prova1\laravel\resources\views/layout/inicial.blade.php ENDPATH**/ ?>