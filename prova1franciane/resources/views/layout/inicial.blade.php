			...
			<ul class="menu"> 
				<li><a href="index.html">Inicio</a></li>  
				 <li><a href="">Controle de TCC</a>   
				  <ul class="submenu-1"> 
				   <li><a href="{{route('areageral')}}>Área Geral</a></li>           
				    <li><a href="{{route('areaadmin')}}">Área Administrativa</a></li> </ul>
				...
				  
				 ...
				 <li><a href="#">Cliente</a>   
				  <ul class="submenu-1">      
				   <li><a href="{{route('areaadm.listaAluno')}}">Listar Alunos </a></li>           
				    <li><a href="{{route('areaadm.listaProfessor')}}">Listar Professores</a></li> </ul>
				  
			</li>    
			   
